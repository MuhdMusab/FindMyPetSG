...
class DatabaseMethods {
  ...
  static Future<void> addPost(
      String username, String post, int postIndex) async {
    ...
    FirebaseFirestore.instance
        .collection("users")
        .doc(username)
        .update({"posts": mapOfPosts});
  }

  static Future<void> addImageToPost(
    String username,
    String postId,
    String post,
  ) async {
  ...
  static Future<void> editPostAtIndex(
      String username, String postId, String post, int postIndex) async {
    DocumentSnapshot<Map<String, dynamic>> snapshot =
        await FirebaseFirestore.instance.collection("posts").doc(postId).get();
    List<dynamic> photoUrls = snapshot['photoUrls'];
  ...
  static Future<int> getNumberOfImagesInPost(
  ...
  static Future<Map<String, dynamic>> getUserPosts(String username) async {
    DocumentSnapshot<Map<String, dynamic>> snapshot = await FirebaseFirestore
        ...
        .collection("users")
        .doc(username)
        .get(); //where("name", isEqualTo: username). .catchError((e) {
    Map<String, dynamic> mapOfPosts = snapshot['posts'];
    return mapOfPosts;
  }
  ...
  static Future<void> updatePostField(
      String username, String postId, String field, dynamic newField) async {
    DocumentSnapshot<Map<String, dynamic>> snapshot =
        await FirebaseFirestore.instance.collection("posts").doc(postId).get();
    FirebaseFirestore.instance
        .collection("posts")
  ...
  static Future<void> deleteUserPostAtIndex(
      String username, int postIndex) async {
  ...
  static Future<void> addStorageReference(
      String username, String ref, int refIndex) async {
    DocumentSnapshot<Map<String, dynamic>> snapshot = await FirebaseFirestore
        .instance
        .collection("users")
        .doc(username)
    ...
    FirebaseFirestore.instance
        .collection("users")
        .doc(username)
        .update({"storageRefs": mapOfStorageRefs});
  }

  static Future<void> deleteStorageRefAtIndex(
      String username, int postIndex) async {
    Map<String, dynamic> mapOfStorageRefs =
        await getUserStorageReference(username);
  ...
  static Future<void> editStorageReferenceAtIndex(
      String username, String ref, int mapIndex, int refIndex) async {
    DocumentSnapshot<Map<String, dynamic>> snapshot = await FirebaseFirestore
        .instance
        .collection("users")
        .doc(username)
  ...
  static Future<String> getStorageReferenceAtIndex(
      String username, int mapIndex, int refIndex) async {
    DocumentSnapshot<Map<String, dynamic>> snapshot = await FirebaseFirestore
        .instance
        .collection("users")
        .doc(username)
  ...
  static Future<Map<String, dynamic>> getUserStorageReference(
  ...
  static Future<void> editProfilePicLink(
      String username, String profilePicLink) async {
    FirebaseFirestore.instance
        .collection("users")
        .doc(username)
        .update({'profilePics': profilePicLink});
  }
