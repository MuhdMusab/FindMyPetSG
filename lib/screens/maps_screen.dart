...
class _MapsScreenState extends State<MapsScreen> {
  ...
  Set<Marker> buildMarkers(AsyncSnapshot<QuerySnapshot<Map<String, dynamic>>> snapshot) {
    ...
    for (int i = 0; i < numberOfPosts; i++) {
      markers.add(
          Marker(
              ...
              position: LatLng(snapshot.data!.docs[i].data()['latitude'], snapshot.data!.docs[i].data()['longtitude']),
              onTap: () => showDialog(
                  context: context,
